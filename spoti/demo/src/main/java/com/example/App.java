...
public class App extends Application {
    ...
    public static void playSong(org.bson.Document song) {
        try {
            ...
            if (mongoService != null) {
                mongoService.incrementGlobalPlayCount(song.getObjectId("_id"));
            }

            // Increment personal play count for logged-in user
            String username = getCurrentUsername();
            if (username != null && mongoService != null) {
                mongoService.updateSongPlayCounts(song.getObjectId("_id"), username, 1);
            }
        } catch (Exception e) {

...
public class MongoService {
    ...
    public void initializeTopHitsPlaylist() {
        ...
        for (Document song : allSongs) {
            addSongToPlaylist("Top Hits", song, "admin");
        }
    }
        ...
        try {
            ...
            for (Document song : allSongs) {
                ...
                if (!song.containsKey("imagePath")) {
                    ...
                    // Fix old paths
                    String currentPath = song.getString("imagePath");
                    if (currentPath != null && currentPath.startsWith("/com/example/images/Albums")) {
                        song.put("imagePath", currentPath.replace("/com/example/images/Albums", "/Albums"));
                    }
                }
